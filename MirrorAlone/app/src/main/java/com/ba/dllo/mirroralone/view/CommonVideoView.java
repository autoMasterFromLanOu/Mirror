...
public class CommonVideoView extends FrameLayout implements MediaPlayer.OnPreparedListener,
    ...
    private ImageView normalScreenImg;
...
//        int wid = ScreenUtils.getScreenWidth(context);
        int height = ScreenUtils.getScreenHeight(context);
//        this.setLayoutParams(new LinearLayout.LayoutParams(wid, height));
        this.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, height-73));
        videoView.requestLayout();
    }

    public void setNormalScreen() {
        touchStatusImg.setImageResource(R.mipmap.iconfont_enter);
        int wid = ScreenUtils.getScreenWidth(context);
        this.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 330));
        videoView.requestLayout();
    }
    ...
    private void initView() {
        View view = LayoutInflater.from(context).inflate(R.layout.view_common_videoview, null);
        viewBox = (FrameLayout) view.findViewById(R.id.viewBox);
        videoView = (MyVideoView) view.findViewById(R.id.view_my_videoview);
        ...
        normalScreenImg = (ImageView) view.findViewById(R.id.screen_status_img);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (deltaXAbs > 1) {
                    ...
                    if (deltaX > 1) {
                        ...
                        touchStatusImg.setImageResource(R.mipmap.ic_fast_forward_white);
                        ...
                        touchPosition = position;
                        touchStatusImg.setImageResource(R.mipmap.ic_fast_rewind_white);
                        int[] time = getMinuteAndSecond(position);
                        touchStatusTime.setText(String.format("%02d:%02d/%s", time[0], time[1], formatTotalTime));
